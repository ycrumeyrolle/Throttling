...
namespace Throttling
{
    public static class ThrottlePolicyBuilderBandwidthExtensions
    {
        ...
        public static ThrottlePolicyBuilder LimitAuthenticatedUserBandwidth(this ThrottlePolicyBuilder builder, long bandwidth, TimeSpan renewalPeriod, bool sliding = false)
        {
            if (builder == null)
            {
        ...
        /// <param name="sliding">Indicates wether the renewal period is sliding.</param>
        /// <returns>The current policy builder.</returns>
        public static ThrottlePolicyBuilder LimitClientBandwidthByQueryStringParameter(this ThrottlePolicyBuilder builder, string queryStringParameter, long bandwidth, TimeSpan renewalPeriod, bool sliding = false)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
