...
namespace Throttling
{
    public static class ThrottlePolicyBuilderRateExtensions
    {
        ...
        /// <param name="sliding">Indicates wether the renewal period is sliding.</param>
        /// <returns>The current policy builder.</returns>
        public static ThrottlePolicyBuilder LimitIPRate(this ThrottlePolicyBuilder builder, long calls, TimeSpan renewalPeriod, bool sliding = false)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
        ...
        /// <param name="sliding">Indicates wether the renewal period is sliding.</param>
        /// <returns>The current policy builder.</returns>
        public static ThrottlePolicyBuilder LimitClientRateByFormParameter(this ThrottlePolicyBuilder builder, string formParameter, long calls, TimeSpan renewalPeriod, bool sliding = false)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
        ...
        /// <param name="sliding">Indicates wether the renewal period is sliding.</param>
        /// <returns>The current policy builder.</returns>
        public static ThrottlePolicyBuilder LimitClientRateByHeader(this ThrottlePolicyBuilder builder, string headerName, long calls, TimeSpan renewalPeriod, bool sliding = false)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
        ...
        /// <param name="sliding">Indicates wether the renewal period is sliding.</param>
        /// <returns>The current policy builder.</returns>
        public static ThrottlePolicyBuilder LimitClientRateByRoute(this ThrottlePolicyBuilder builder, string routeTemplate, string routeFragment, long calls, TimeSpan renewalPeriod, bool sliding = false)
        {
            if (builder == null)
            {
                throw new ArgumentNullException(nameof(builder));
